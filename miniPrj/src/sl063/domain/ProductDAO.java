...
//                " select ProductID,MallID,ProductName,Company,Price1,Price2,Install,keyword,Detail,ProductDate,PHOTODIR,rnum from ( "+
//                " select ProductID,MallID,ProductName,Company,Price1,Price2,Install,keyword,Detail,ProductDate,PHOTODIR,rownum rnum from("+
//                " select ProductID,MallID,ProductName,Company,Price1,Price2,Install,keyword,Detail,ProductDate,PHOTODIR from product "+"" +
//                ")) ORDER BY RNUM";
        String RETRIEVE_STMT ="select ProductID,MallID,ProductName,Company,Price1,Price2,Install,keyword,Detail,ProductDate,PHOTODIR from product order by productid";
