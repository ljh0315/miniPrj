...
<table width="1000" border="1" cellspacing="0" cellpadding="0" align="center">
   ...
   <tr>
    ...
    <td  width="660">
       <input type="text" size="80" maxlength="20" name="writer"></td>
  </tr>
  <tr>
	...
	<%}else{%>
	   <input type="text" size="80" maxlength="50" name="subject" value="[답변]"></td>
	<%}%>
  </tr>
  <tr>
    <td  width="70" align="center">Email</td>
    <td  width="330">
       <input type="text" size="80" maxlength="20" name="email" ></td>
  </tr>
  <tr>
