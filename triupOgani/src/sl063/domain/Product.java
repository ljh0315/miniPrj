...
public class Product {
    ...
    public Product(String ProductId) {
        this(ProductId, "", "", "",0, 0, "", "", "", null,"", 0);
    }
    
    public Product(int cateNum) {
    ...
    public Product(String productId, String mallId, String productName, String company,
            int price1,int price2,String install, String keyword,String detail,Date productDate,String photoDir, int cateNum) {
