...
<body>
				...
				<div class="col-lg-6">
					<nav class="header__menu">
						<ul>
							...
							<li><a href="../boardController?choice=getAll-board">후기
									게시판</a></li>
	...
	<div align="center">
		...
		<form method="post" name="writeform"
			action="../qnaController?choice=insert-board"
			...
			<table width="400" border="1" cellspacing="0" cellpadding="0"
				...
				<tr height="30">
					<td align="right" colspan="2" bgcolor="<%=value_c%>"><a
						href="../qnaController?choice=getAll-board"> 글목록</a></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan=2 bgcolor="<%=value_c%>" align="center"><input
						...
						OnClick="window.location='../qnaController?choice=getAll-board'">
					</td>
				</tr>
			</table>
			<%
