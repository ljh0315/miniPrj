...
<body>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="img/area_banner.png">
        <div class="container">
            <div class="row">
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg">
									<a href='mainController?choice=select-product&productId=<%=product.getProductId()%>'>
									<img width="270" height="270" src="area-img/<%=product.getPhotoDir()%>">									
								</div>
