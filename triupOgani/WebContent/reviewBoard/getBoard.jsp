  ...
  <tr height="30">      
    <td colspan="4" bgcolor="<%=value_c%>" align="right" > 
	  ...
	  <input type="button" value="글삭제" 
       onclick="document.location.href='reviewBoard/deleteForm.jsp?num=<%=board.getNum()%>&pageNum=<%=pageNum%>'">
	   &nbsp;&nbsp;&nbsp;&nbsp;
      <input type="button" value="답글쓰기" 
       onclick="document.location.href='reviewBoard/writeForm.jsp?num=<%=num%>&ref=<%=ref%>&re_step=<%=re_step%>&re_level=<%=re_level%>'">
	   &nbsp;&nbsp;&nbsp;&nbsp;
