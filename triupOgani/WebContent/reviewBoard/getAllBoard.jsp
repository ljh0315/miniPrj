...
<body>
		...
		<div class="container">
			...
			<div align="center">
				<table width="700" bgcolor="<%=value_c%>" border="1">
					<tr>
						<td style="border-right: hidden;"><b>후기 게시판(전체 글:<%=count%>)
						</b></td>
						<td align="right"><a href="index.jsp">홈으로 이동</a> <a
							href="reviewBoard/writeForm.jsp">글쓰기</a></td>
				</table>
 ...
 %> <img
				...
				%>
				<a
					href="boardController?choice=getAll-board&pageNum=<%=startPage - 10%>&startRow=<%=(startPage - 1) * 10 + 1%>&endRow=<%=startPage * 10%>">[이전]</a>
				<%
					}
				...
				%>
				<a
					href="boardController?choice=getAll-board&pageNum=<%=startPage + 10%>&startRow=<%=(startPage - 1) * 10 + 1%>&endRow=<%=startPage * 10%>">[다음]</a>
				<%
					}
					}
				%>
